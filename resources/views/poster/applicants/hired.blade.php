 ...
 ================================================== -->
    <div class="container">
        ...
        <div class="sixteen columns">
            ...
            <strong><a href="{{route('applicant.get.hired',$job_id)}}" class="download-csv">View Hired <i class="fa fa-users"></i></a></strong>
        </div>
                ...
                <div class="application">
                    <div class="app-content">
                        ...
                        <div class="info">
                            ...
                            <span>{{\App\Helpers\Sitso::getAUser($my_applicant->applicant_id)}}</span>
                            <ul>
                                <li><a href="#"><i class="fa fa-envelope"></i>{{\App\Helpers\Sitso::getEmail($my_applicant->applicant_id)}}</a></li>
                                <li><a href="{{route('applicant.resumes',[$my_applicant->applicant_id,\Faker\Provider\Uuid::uuid()])}}"><i class="fa fa-file-text"></i>Job Experience</a></li>
