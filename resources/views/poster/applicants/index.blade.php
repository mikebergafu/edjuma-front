 ...
 ================================================== -->
    <div class="container">
        ...
        <div class="sixteen columns">
            ...
            <p class="margin-bottom-25" style="float: left;">The job applications for <strong><a href="{{route('my.job.postings',\Faker\Provider\Uuid::uuid())}}">Jobs</a></strong> are listed below.</p>
                ...
                <!-- Application #1 -->
                    <div class="application">
                        <div class="app-content">
                            ...
                            <div class="info">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{route('applicant.resumes',[$my_applicant->user_id,\Faker\Provider\Uuid::uuid()])}}"><i class="fa fa-file-text"></i>Resume</a></li>
                        ...
                        <div class="app-footer">
                            ...
                            <ul>
                                <li><a href="#"><i class="fa fa-user-plus"></i>Add to Shortlist</a></li>
