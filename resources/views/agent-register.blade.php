        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>Job Seeker / Job Poster</h3>
                        <form method="POST" action="">
                            @csrf

                            <div class="form-group row">
                                <label for="name" class="col-12 col-form-label text-left">{{ __('First Name') }} <span class="mendatory-mark">*</span></label>
                            ...
                            <div class="form-group row">
                                <label for="company" class="col-12 col-form-label text-left">{{ __('Last Name') }} <span class="mendatory-mark">*</span></label>
                                <div class="col-12">
